...
int main()
{
    ...
    GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "CG_P6", nullptr, nullptr);
    if (!window)
    {
        glfwTerminate();
        exit(EXIT_FAILURE);
    ...
    getShader(&tessControlShader, (char *)"shaders/tess_control.glsl", GL_TESS_CONTROL_SHADER);
    GLuint tessEvaluationShader;
    getShader(&tessEvaluationShader, (char *)"shaders/tess_eval.glsl", GL_TESS_EVALUATION_SHADER);
    GLuint fragmentShader;
    getShader(&fragmentShader, (char *)"shaders/fragment.glsl", GL_FRAGMENT_SHADER);
    GLuint shaderProgram;
    getShaderProgram(&shaderProgram, 5, &vertexShader, &tessControlShader, &tessEvaluationShader, &geometryShader, &fragmentShader);
